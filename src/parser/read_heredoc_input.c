...
static int	handle_heredoc_child(t_shell *shell, const char *file_name, const char *delimiter);
static char	*get_colourful_delimiter(const char *delimiter);
static void	run_heredoc_loop(const char *delimiter, int fd, const char *colourful_delimiter);
